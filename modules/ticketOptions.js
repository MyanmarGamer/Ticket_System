...
module.exports = function (client, options) {
    ...
    client.on("interactionCreate", async (interaction) => {
        try {
            ...
            if (interaction.member.roles.cache.has(config.ticket.roles.head_supporter) || interaction.member.roles.cache.has(config.ticket.roles.head_bot_creator) || interaction.member.roles.cache.has(config.ticket.roles.moderator) || interaction.member.roles.cache.has(config.ticket.roles.supporter) || interaction.member.roles.cache.has(config.ticket.roles.staff) || interaction.member.roles.cache.has(config.ticket.roles.bot_creator)) {
                    ...
                    switch (interaction.customId) {
                        case "ticket-close":
                            ...
                            interaction.channel.edit({
                                    ...
                                    parent: config.ticket.extra.closed
                                }),
...
Claimed By: **${TranscriptClimedByUser.user.tag}** (${TranscriptClimedByUser.id})`)
                                ...
                                const transcriptChannel = interaction.guild.channels.cache.get(config.ticket.extra.transcript);
                                ...
                                const transcriptChannel = await interaction.guild.channels.cache.get(config.ticket.extra.transcript);
                                transcriptChannel.send({
                                    embeds: [transcriptSendEmbed],
                                    files: [attachment]
                                });
